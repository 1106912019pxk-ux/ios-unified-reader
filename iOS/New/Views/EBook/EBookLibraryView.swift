...
struct EBookLibraryView: View {
    ...
    var body: some View {
        ...
        .safeAreaInset(edge: .bottom) {
            HStack {
                Label("Local files only", systemImage: "iphone")
                    .font(.caption)
    ...
    private var emptyLibrary: some View {
        VStack(spacing: 14) {
            ...
            Text("No e-books")
                .font(.title2.bold())
            Text("Import EPUB, PDF, TXT, Markdown, or HTML files.\nComic archives stay in the manga library.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
            ...
            Button {
                ...
                Label("Import local files", systemImage: "plus")
            }
            .buttonStyle(.borderedProminent)
        }

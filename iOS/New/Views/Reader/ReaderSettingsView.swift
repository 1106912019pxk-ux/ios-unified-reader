...
/// Registers fonts imported by the native text reader. The directory deliberately
/// matches the previous ebook implementation so fonts survive an in-place update.
@MainActor
...
/// Shared by the global experimental text-reader settings and the in-reader sheet.
@MainActor
